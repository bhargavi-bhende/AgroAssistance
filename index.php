                ...
                <div class="card shadow-lg p-3 mb-5 bg-white rounded mr-5 ">
                    <div class="card-body text-center" style="height:500px">
                        ...
                        <div class="tab-content pt-2 pl-1" id="pills-tabContent">
                                ...
                                <form onsubmit="return validateFarmer()" method="POST" class="text-center border border-light p-5" style="height:350px" action="login.php">
                                    ...
                                    <p>Not a member?
                                    <a href="farmer_regist.php" style="color: #AA9A6E;">Register</a>
                                    </p>
                            ...
                            <div class="tab-pane fade" id="pills-customer" role="tabpanel" aria-labelledby="pills-customer-tab">
                                <form onsubmit="return validateCustomer()" class="text-center border border-light p-5" action="login.php" method="POST">
