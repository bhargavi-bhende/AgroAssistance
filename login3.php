...
if(count($_POST)>0) {
	$result = mysqli_query($conn,"SELECT * FROM agencylogin WHERE password = '". $_POST["password"]."'and agency_name= '". $_POST["agency_name"]."'");
	...
	if($count==0) {
		...
		echo "<script>window.location.href='dashboard3.html';</script>";
    ...
    <div class="container">
        ...
        <div class="top">
           <!-- <span>Have an account?</span> -->
            <header>Login</header>
            <form  id="login" class="login-data" method="post" action="login3.php">
        </div>
        ...
        <div class="two-col">
            ...
            <div class="two">
                <label><a href="agro_regist.php">Don't have an account?</a></label>
            </div>
        </div>
</form></form>
    </div>
