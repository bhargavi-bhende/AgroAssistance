...
<?php
    ...
    if(isset($_POST['submitsignup']))
    {
        ...
        $insertquery = "INSERT INTO buyerlogin('buyer_name', 'password', 'email', 'phoneno','address') 
        VALUES ('$buyername','$pass','$email','$phone','$address');";
...
if(count($_POST)>0) {
	$result = mysqli_query($conn,"SELECT * FROM buyerlogin WHERE password = '". $_POST["password"]."'and buyer_name= '". $_POST["buyer_name"]."'");
    ...
    <div class="container">
        ...
        <div class="top">
           <!-- <span>Have an account?</span> -->
            <header>Login</header>
            <form  id="login" class="login-data" method="post" action="login2.php">
        </div>

        <div class="input-field">
            <input type="text" class="input" placeholder="Username" id="" name='buyer_name'>
        ...
        <div class="two-col">
            ...
            <div class="two">
                <label><a href="buyer_regist.php">Don't have an account?</a></label>
            </div>
        </div>
</form></form>
    </div>
